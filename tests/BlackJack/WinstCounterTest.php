 ...
 */
class WinstCounterTest extends TestCase
{
    /**
    ...
    public function testCreateObject(): void
    {
        ...
        $this->assertInstanceOf("\App\BlackJack\WinstCounter", $game);
    ...
    {   //finish with bank ready
        ...
        $game->setBank($bank);
        $this->assertTrue($game->finish());

        // finish if playing contain no players
        $game1 = new WinstCounter();
        $desk = new Desk();
        ...
        $game4 = new WinstCounter();
        $player = new Player();
        $player->setName('Jul');
        $game4->addPlaying('Jul', $player);
        $bank = $this->createMock(Bank::class);
        $bank->method('points')->willReturn(15);
        $bank->method('blackJack')->willReturn(false);
