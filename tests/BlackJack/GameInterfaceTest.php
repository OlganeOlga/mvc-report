 ...
 */
class GameIntefaceTest extends TestCase
{
    /**
    ...
    public function testCountWinstBankBJ(): void
    {
        ...
        $this->assertEquals(-1, $game->findPlayer('Jana', 'ready')->getProfit());// insuranse doesnot work !!!!
    ...
    public function testCountWinstBAnkWin(): void
    {
        ...
        $this->assertEquals(-2, $game->findPlayer('Per', 'ready')->getProfit());
        $this->assertEquals(-2, $game->findPlayer('Björn', )->getProfit());
        $this->assertEquals(-2, $game->findPlayer('Sten', )->getProfit());
    }
    ...
    public function testCountWinstBankPlaying(): void
    {
        ...
        $this->assertEquals(-2, $game->findPlayer('Sten', )->getProfit());
        $this->assertEquals(2, $game->findPlayer('Stan', )->getProfit());
    ...
    public function testCountWinstBAnkFat(): void
    {
         ...
         * Player 3 Dirk1 profit 3 with status "wait"
        ...
        $game->addPlaying('Dirk1', $player3); // status wait doesnot work
        ...
        $this->assertEquals(2, $game->findPlayer('Sten1', )->getProfit());
    }
}